...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(strlen($nome) > 0 && strlen($url))
    {
        ...
        // {
            $low_res_image_name =  strlen($imagem_low) > 0 ? $imagem_low : $_FILES["low_res_image"]["name"];
            $high_res_image_name =  strlen($imagem_high) > 0 ? $imagem_high : $_FILES["high_res_image"]["name"];
