...
<div class="span9" >     
                ...
                <h2 class="page-header" style="text-align: left;">Leads&nbsp;
            ...
            <form method="GET">
                    <div class="row-fluid pull">
                        ...
                        <div class="span2">                             
                            <select name="year">
                                ...
                                <?php for($i = 2010; $i <= $current_year; $i++){ ?>
                                    <option value="<?php echo $i; ?>" selected="<?php echo $i == $year ? 'selected' : 'false'; ?>"><?php echo $i; ?></option>
                                <?php } ?>
                            </select>    
                        </div>
                        <div class="span2">                             
                        ...
                        <div class="span4">                                                      
                            <a href="export/listagem_leads.php?month=<?php echo $month; ?>&year=<?php echo $year; ?>&query=<?php echo $query; ?>" class="btn btn-success">Exportar (Excel)</a>
                                          ...
                                          <?php 
                                            ...
                                            while($array = mysqli_fetch_array($statement)){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo strlen(utf8_encode($array['pagina_origem'])) > 0 ? utf8_encode($array['pagina_origem']) : 'Nenhuma'; ?></td>
                                                </tr>
