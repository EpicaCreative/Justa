...
<!-- End Facebook Pixel Code -->
  <meta charset="utf-8">
  <title>Maquininhas - Justa</title>
  <!-- HTML 4 -->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<!-- HTML5 -->
<meta charset="utf-8"/>
  <title>Maquininhas - Justa</title>
  <meta content="MAQUININHAS" property="og:title">
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <meta content="Webflow" name="generator">
  <link href="css/normalize.css" rel="stylesheet" type="text/css">
  <link href="css/justa-maquininhas-webflow.css" rel="stylesheet" type="text/css">
  <link href="css/justa-maquininhas.css" rel="stylesheet" type="text/css">
...
<body class="body">
  ...
  <div class="section-19"></div>
  <div class="section-11">
    <div class="container-5 w-container"><iframe class="threed" src="https://epicacreative.com.br/justa/3d/ex/3d/"style="pointer-events:none;" frameborder="0" ></iframe></div>
  </div>
  <div class="section-17">
    <h1 class="heading-4-copy5">Nossas máquinas tem tudo o que as </h1>
    <h1 class="heading-4-copy5-copy3">outras dizem ser “diferenciais”, <br></h1>
    <h1 class="heading-4-copy5-copy-copy">mas para nós é apenas o básico.</h1><a href="#" class="button-4-copy-copy w-button" onClick="ModalInteresse()" style="line-height: 25px;">Peça a sua</a></div>
  <div id="sobre" class="section-1">
    <h1 class="heading-16-copy">Não existe nada mais <strong>JUSTO</strong> do que cobrar apenas o que foi combinado.</h1>
    <h1 class="heading-16">Não existe nada mais <strong>JUSTO</strong> do que cobrar apenas o que foi combinado.</h1>
  </div>
  <div class="section-12">
    <div class="container-6 w-container"><img src="images/sobre-maquininhas.webp" srcset="images/sobre-maquininhas-p-500.png 500w, images/sobre-maquininhas-p-800.png 800w, images/sobre-maquininhas.webp 958w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 50vw, (max-width: 991px) 364px, 100vw" alt="" class="image-34-copy3434">
      <p class="paragraph-9">Um portal <strong>JUSTO</strong> exclusivo para os Heróis (Clientes)No<strong> PORTAL JUSTO</strong> você possuí autonomia total sobre seu negócio.<br><br>Você encontra todas as informações de forma FÁCIL e RÁPIDA, sem pegadinhas e com muita transparência. Tudo o que foi combinado está explícito, sem letras miúdas.<br><br>Simples, breve e leve. Como deve ser! O <strong>PORTAL JUSTO</strong> exibe o custo efetivo de cada venda, taxa, antecipação e o crédito <strong>JUSTO</strong> para que todo seu foco seja voltado a vendas, sem preocupação com o recebimento.<br>Não basta parecer, temos que ser <strong>JUSTOS</strong>! É isso que nós da <strong>JUSTA</strong> acreditamos e executamos.<br><br>Não importa a tecnologia que seu negócio precisa, seja ele <strong>JUSTA MAIS</strong> ou <strong>MAQUININHA</strong>, sempre terá o <strong>PORTAL JUSTO</strong> para você acompanhar tudo de primeira mão.<br><br>Em um único portal você acompanha todas as vendas realizadas pelo <strong>JUSTA+</strong> e/ou pelo POS (Maquininha <strong>JUSTA</strong>).<br></p><a href="#" class="button-4-copy w-button" onclick="AbreModal()">ACESSE O PORTAL</a></div>
    <div class="w-clearfix">
      <div class="columns-18 w-row">
        <div class="column-39 w-col w-col-6">
          <h1 class="heading-4-copy6">Portal JUSTO</h1>
          <p class="paragraph-9">Um portal <strong>JUSTO</strong> exclusivo para os Heróis (Clientes). No<strong> PORTAL JUSTO</strong> você possui autonomia total sobre seu negócio.<br><br>Você encontra todas as informações de forma FÁCIL e RÁPIDA, sem pegadinhas e com muita transparência. Tudo o que foi combinado está explícito, sem letras miúdas.<br><br>Simples, breve e leve. Como deve ser! O <strong>PORTAL JUSTO</strong> exibe o custo efetivo de cada venda, taxa, antecipação e o crédito <strong>JUSTO</strong> para que todo seu foco seja voltado a vendas, sem preocupação com o recebimento.<br>Não basta parecer, temos que ser <strong>JUSTOS</strong>! É isso que nós da <strong>JUSTA</strong> acreditamos e executamos.<br><br>Não importa a tecnologia que seu negócio precisa, seja ele <strong>JUSTA MAIS</strong> ou <strong>MAQUININHA</strong>, sempre terá o <strong>PORTAL JUSTO</strong> para você acompanhar tudo de primeira mão.<br><br>Em um único portal você acompanha todas as vendas realizadas pelo <strong>JUSTA+</strong> e/ou pelo POS (Maquininha <strong>JUSTA</strong>).<br></p><a href="#" class="button-4-copy w-button" onclick="AbreModal()">ACESSE O PORTAL</a></div>
        <div class="column-38 w-col w-col-6"><img src="images/sobre-maquininhas.webp" srcset="images/sobre-maquininhas-p-500.png 500w, images/sobre-maquininhas-p-800.png 800w, images/sobre-maquininhas.webp 958w" sizes="(max-width: 991px) 100vw, 34vw" alt="Qual a melhor maquininha de cartão" class="image-34"></div>
      </div>
    </div>
  </div>
  <div class="section-12-copy">
    <div data-animation="cross" data-easing="ease-in-out-circ" data-disable-swipe="1" data-duration="1000" data-infinite="1" class="slider-6 w-slider">
      <div class="w-slider-mask">
        <div class="slide-6 w-slide">
          <h1 class="heading-4-copy6-copy">Portal JUSTO</h1><img src="images/sobre-maquininhas.webp" srcset="images/sobre-maquininhas-p-500.png 500w, images/sobre-maquininhas-p-800.png 800w, images/sobre-maquininhas.webp 958w" sizes="(max-width: 479px) 70vw, 100vw" alt="" class="image-34-copy-copy">
          <p class="paragraph-9-copy2">Um portal <strong>JUSTO</strong> exclusivo para os Heróis (Clientes)No<strong> PORTAL JUSTO</strong> você possuí autonomia total sobre seu negócio.<br></p>
        </div>
        <div class="slide-7 w-slide">
          <p class="paragraph-9-copyslide2-copy">Você encontra todas as informações de forma FÁCIL e RÁPIDA, sem pegadinhas e com muita transparência. Tudo o que foi combinado está explícito, sem letras miúdas.<br><br>Simples, breve e leve. Como deve ser! O <strong>PORTAL JUSTO</strong> exibe o custo efetivo de cada venda, taxa, antecipação e o crédito <strong>JUSTO</strong> para que todo seu foco seja voltado a vendas, sem preocupação com o recebimento. Não basta parecer, temos que ser <strong>JUSTOS</strong>! É isso que nós da <strong>JUSTA</strong> acreditamos e executamos.<br></p>
        </div>
        <div class="slide-8 w-slide">
          <p class="paragraph-9-copyslider3-copy">Não importa a tecnologia que seu negócio precisa, seja ele <strong>JUSTA MAIS</strong> ou <strong>MAQUININHA</strong>, sempre terá o <strong>PORTAL JUSTO</strong> para você acompanhar tudo de primeira mão.<br><br>Em um único portal você acompanha todas as vendas realizadas pelo <strong>JUSTA+</strong> e/ou pelo POS (Maquininha <strong>JUSTA</strong>).<br>‍<br></p><img src="images/slider3maquininhas.png" alt="Qual é a melhor maquininha de cartão" class="image-48"></div>
      </div>
      <div class="left-arrow-4 w-slider-arrow-left"></div>
      <div class="right-arrow-4 w-slider-arrow-right"><img src="images/play-copia54.png" alt="Maquininha de cartão com as melhores taxas"></div>
    ...
    <div class="w-clearfix">
      <div class="columns-18 w-row">
        <div class="column-39 w-col w-col-6">
          <p class="paragraph-9">Um portal <strong>JUSTO</strong> exclusivo para os Heróis (Clientes)No<strong> PORTAL JUSTO</strong> você possuí autonomia total sobre seu negócio.<br><br>Você encontra todas as informações de forma FÁCIL e RÁPIDA, sem pegadinhas e com muita transparência. Tudo o que foi combinado está explícito, sem letras miúdas.<br><br>Simples, breve e leve. Como deve ser! O <strong>PORTAL JUSTO</strong> exibe o custo efetivo de cada venda, taxa, antecipação e o crédito <strong>JUSTO</strong> para que todo seu foco seja voltado a vendas, sem preocupação com o recebimento.<br>Não basta parecer, temos que ser <strong>JUSTOS</strong>! É isso que nós da <strong>JUSTA</strong> acreditamos e executamos.<br><br>Não importa a tecnologia que seu negócio precisa, seja ele <strong>JUSTA MAIS</strong> ou <strong>MAQUININHA</strong>, sempre terá o <strong>PORTAL JUSTO</strong> para você acompanhar tudo de primeira mão.<br><br>Em um único portal você acompanha todas as vendas realizadas pelo <strong>JUSTA+</strong> e/ou pelo POS (Maquininha <strong>JUSTA</strong>).<br></p><a href="#" class="button-4-copy w-button">ACESSE O PORTAL</a></div>
        <div class="column-38 w-col w-col-6"><img src="images/sobre-maquininhas.png" srcset="images/sobre-maquininhas-p-500.png 500w, images/sobre-maquininhas-p-800.png 800w, images/sobre-maquininhas.png 958w" sizes="100vw" alt="Qual a melhor maquina de cartão com menor taxa" class="image-34"></div>
      </div>
    </div><a href="#" class="button-4-copy-copy w-button" onclick="AbreModal()" style="line-height: 25px;">ACESSE O PORTAL</a></div>
 <div id="Contatos" class="contatos">
    <div class="columns-13 w-row">
      <div class="w-col w-col-6"><img src="images/textos_contato.png" alt="Qual a melhor maquininha de cartão para MEI" class="image-23"></div>
      <div class="column-51 w-col w-col-6">
        <div class="w-row">
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-32 w-col w-col-6" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"><a href="tel:08008788307" target="_blank" class="link-block-4 w-inline-block w-clearfix"><img src="images/icone_1_contato.png" alt="Melhores taxas maquininha de cartao" class="image-22"><h1 class="contato_1">0800 87 88 307</h1></a></div>
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-32 w-col w-col-6"><a href="mailto:ajuda@justa.com.vc" target="_blank" class="link-block-5 w-inline-block w-clearfix"><img src="images/icone_2_contato.png" alt="Melhores taxas maquina de cartao" class="image-22"><h1 class="contato_1">ajuda@justa.com.vc</h1></a></div>
        </div>
        <div class="columns-14 w-row">
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-34 w-clearfix w-col w-col-6"><img src="images/icone_3_contato.png" alt="Taxas maquinas de cartao de crédito" class="image-22">
            <h1 class="contato_1">Chat</h1>
          </div>
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-33 w-col w-col-6"><a href="http://api.whatsapp.com/send?1=pt_BR&amp;phone=5501149496347" target="_blank" class="link-block-6 w-inline-block w-clearfix"><img src="images/icone_4_contato.png" alt="Maquininha de cartão com as melhores taxas" class="image-22"><h1 class="contato_1">+55 11 94949-6347</h1></a></div>
        </div>
      </div>
    </div>
  </div>
 ...
 <div class="row">
        ...
        <div class="row">
          <div class="col-md-12 com-sm-12">
            ...
            <input data-watermark="Como você descobriu a Justa?" list="how_did_you_meet_us" type="text" id="canal-interesse" class="input-contato" 
      ...
      <div class="row">
        ...
        <center><div class="col-md-12 com-sm-12">
            <a class="button w-button"  id="btnEnviaInteresse" style="display: none; width: 100px;"  onClick="EnviaInteresse('maquininhas.html', true, true)">Enviar</a>
