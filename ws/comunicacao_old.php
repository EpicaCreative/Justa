...
<?php		} 
	...
	if($pagina=="cadastro-interesse"){
			...
			if(mysqli_num_rows($sql)>0){echo trim("Esse e-mail já existe em nossa base de dados. Obrigado");} 
				...
				$sql = mysqli_query($conecta, "INSERT into TB_cadastros_interesse (nome, email, telefone, cidade, estado, obs, data_cadastro, teste, pagina_origem, link_origem) VALUES ('".$_POST['nome']."', '".$_POST['email']."', '".$_POST['telefone']."', '".$_POST['cidade']."', '".$_POST['estado']."', '".$_POST['obs']."', '".date('Y-m-d')."', 'S', '$pagina_origem', '$origin')");
				if($sql){
