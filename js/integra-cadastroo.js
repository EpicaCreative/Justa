...
function mascaraTel(componente){
    ...
    function EnviaLinkou(pagina_origem = ""){
        ...
        let integradoFunilCartao = registra_dados_funil_linkou(nome, email, telefone, cidade, estado, origem);
        
        var pagina = 'cadastro-linkou';
        $.ajax({
