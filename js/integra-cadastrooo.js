...
function mascaraTel(componente){
	...
	$("#"+componente).val(texto); 
     ...
     function EnviaMaquininha(pagina_origem = ""){
        ...
        let integradoFunilCartao = registra_dados_funil_maquininha(nome, email, telefone, cidade, estado, origem);
        
        var pagina = 'cadastro-maquininha';
        $.ajax({
