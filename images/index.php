...
<body class="body">
  ...
  <div class="icones">
    <div class="columns-16 w-row">
      <div data-w-id="4e8457db-90c0-7aaa-766f-561b193f3011" class="w-col w-col-4"><a href="maquininhas.html" class="w-inline-block"><img src="images/maquininha.png" alt="Maquininha de cartão com as melhores taxas" class="imgicone"></a></div>
      <div data-w-id="4e8457db-90c0-7aaa-766f-561b193f3012" class="w-col w-col-4"><a href="justa-mais-tef.html" class="w-inline-block"><img src="images/Justa-Mais.png" alt="Tef maquina de cartão" class="imgicone"></a></div>
      <div data-w-id="e80eecf5-dd05-0ceb-953b-6a2269646475" class="w-col w-col-4"><a href="credito-justo.html" class="w-inline-block"><img src="images/Credito-Justo.png" alt="Credito para micro empresas" class="imgicone"></a></div>
    </div>
  </div>
  ...
  <div class="section-2">
    ...
    <div class="columns-29 w-row">
      <div class="w-clearfix w-col w-col-4 w-col-small-4"><img src="images/bs2.png" alt="Qual a melhor maquininha de cartão" class="image-2" data-ix="new-interaction-4"></div>
      <div class="column-50 w-col w-col-4 w-col-small-4"><a href="https://www.a5.com.br" class="w-inline-block"><img src="images/A5-2.png" alt="Qual é a melhor maquininha de cartão" class="image" data-ix="new-interaction-4"></a>
        <div class="columns-30 w-row">
          <div class="w-col w-col-4 w-col-tiny-4"><img src="images/bs2.png" alt="Maquininha de cartão com as melhores taxas" class="image-2-copy" data-ix="new-interaction-4"></div>
          <div class="column-49 w-col w-col-4 w-col-tiny-4"><img src="images/A5-2.png" alt="Qual máquina de cartão usar" class="image-copy" data-ix="new-interaction-4"></div>
          <div class="w-col w-col-4 w-col-tiny-4"><img src="images/5d1f4d07719f58e40fff7682_rede.png" alt="Qual a melhor maquina de cartão com menor taxa" class="image-copy-rede-copy" data-ix="new-interaction-4" ></div>
        </div>
      </div>
      <div class="w-clearfix w-col w-col-4 w-col-small-4"><img src="images/5d1f4d07719f58e40fff7682_rede.png" alt="Qual a melhor maquininha de cartão para MEI" class="image-copy-rede" data-ix="new-interaction-4" style="margin-top: 25px;"></div>
    </div>
  </div>
  ...
  <div id="justos" class="section-4">
    <div class="columns-7 w-row">
      ...
      <div class="column-16 w-col w-col-7"><img src="images/liga-Justa.png" srcset="images/liga-Justa-p-500.png 500w, images/liga-Justa-p-800.png 800w, images/liga-Justa.png 979w" sizes="(max-width: 479px) 67vw, (max-width: 767px) 54vw, (max-width: 991px) 31vw, 33vw" alt="" class="image-20">
        ...
        </div><img src="images/ligajusta_1.webp" srcset="images/ligajusta_1-p-500.png 500w, images/ligajusta_1-p-800.png 800w, images/ligajusta_1-p-1080.png 1080w, images/ligajusta_1.webp 1368w" sizes="(max-width: 479px) 96vw, 100vw" alt="Autonomo safrapay" class="image-47"></div>
    </div>
  </div>
    ...
    <div class="columns-13 w-row">
      ...
      <div class="column-51 w-col w-col-6">
        ...
        <div class="columns-14 w-row">
          ...
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-33 w-col w-col-6"><a href="http://api.whatsapp.com/send?1=pt_BR&amp;phone=55011944478696" target="_blank" class="link-block-6 w-inline-block w-clearfix"><img src="images/icone_4_contato.png" alt="" class="image-22"><h1 class="contato_1">+55 11 4949-6347</h1></a></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section-5"><div class="formobile">
        <div><img src="images/logo_elo.png" alt="" class="image-4-elo-grande" style="width:80%; margin-bottom: 30px;"></div>
         <img src="images/logo_1.png" alt="" class="image-4" style="width: 25%;"><img src="images/logo_2.png" alt="" class="image-4" style="width: 25%;"><img src="images/logo_5.png" alt="" class="image-4" style="width: 25%;">
  ...
  <img src="images/logo_1.png" alt="" class="image-4" style="width: 7%;"><img src="images/logo_2.png" alt="" class="image-4" style="width: 7%;"><img src="images/logo_5.png" alt="" class="image-4" style="width: 7%;">
    <div class="w-row">
