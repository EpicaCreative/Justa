...
<!--  Last Published: Wed Feb 05 2020 12:35:51 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="5e39d8443e8f04555aa59de7" data-wf-site="5e39d8443e8f045782a59de9">
<head>
  <meta charset="utf-8">
  <title>Parcelinha Justa</title>
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <meta content="Webflow" name="generator">
  <link href="css/normalize.css" rel="stylesheet" type="text/css">
  <link href="css/include-css.css" rel="stylesheet" type="text/css">
  <link href="css/justa-parcelinhawebflow.css" rel="stylesheet" type="text/css">
  <link href="css/justa-parcelinha.css" rel="stylesheet" type="text/css">
...
<meta name="description" content="A maquininha da Justa que paga boletos.">
</head>
<body class="body">
  <div class="section">
  ...
  </div><img src="images/sobrando-conta-no-final-do-mes-parcelinha-justa-maquininha-que-paga-contas.jpg" srcset="images/sobrando-conta-no-final-do-mes-parcelinha-justa-maquininha-que-paga-contas-p-500.jpeg 500w, images/sobrando-conta-no-final-do-mes-parcelinha-justa-maquininha-que-paga-contas-p-1080.jpeg 1080w, images/sobrando-conta-no-final-do-mes-parcelinha-justa-maquininha-que-paga-contas-p-1600.jpeg 1600w, images/sobrando-conta-no-final-do-mes-parcelinha-justa-maquininha-que-paga-contas.jpg 1918w" sizes="(max-width: 1918px) 100vw, 1918px" alt="" class="image-57">
  <div class="section-23">
    <h1 class="heading-19">Pagar boletos pelo cartão na maquininha da Justa?</h1>
    <h1 class="heading-19-copy">Sim, agora é possível.</h1>
    <div class="columns-40 w-row">
      <div class="column-63 w-col w-col-6">
        <p class="paragraph-15"><br>É por isso que a PARCELINHA JUSTA existe!<br><br>Agora é possível pagar boletos através da maquininha da Justa, com cartão de crédito e em até 12 vezes. Ah, o mais legal de tudo isso, é que você ou seu cliente terão diversas formas para escolher como pagar.<br><br>Faça uma simulação em tempo real com nossos especialistas.A gente sabe o quanto é difícil manter os pagamentos em dia. </p>
        <p class="paragraph-15-copy">Muito mais que uma maquininha de cartão, uma máquina de crédito!</p>
      </div>
      <div class="column-65 w-col w-col-6"><img src="images/Maquininha-que-paga-boleto.jpg" srcset="images/Maquininha-que-paga-boleto-p-500.jpeg 500w, images/Maquininha-que-paga-boleto.jpg 555w" sizes="(max-width: 479px) 93vw, (max-width: 991px) 300px, 48vw" alt="" class="image-60"></div>
    </div>
  </div>
  <div class="section-24">
    <div class="columns-41 w-row">
      <div class="column-63-copy w-col w-col-6 w-col-small-6"><img src="images/diversas-formas-para-escolher-como-pagar-seu-boleto-com-a-Justa.jpg" alt="" class="image-61">
        <p class="paragraph-16">Diversas formas para escolher como pagar o seu boleto ou do seu cliente, garantindo essa vantagem para seu estabelecimento.</p>
      </div>
      <div class="column-64-copy w-col w-col-6 w-col-small-6"><img src="images/pagamento-em-ate-doze-vezes-no-cartao-de-credito-com-a-justa.jpg" alt="" class="image-61">
        <p class="paragraph-16">Pagamento em até 12 vezes no cartão de crédito, com taxas JUSTAS.</p>
      </div>
    </div>
    <div class="columns-42 w-row">
      <div class="column-63-copy w-col w-col-6 w-col-small-6"><img src="images/atendimento-online-facil-e-rapido-com-feedback-na-justa-com-vc.jpg" alt="" class="image-61">
        <p class="paragraph-16">Atendimento online fácil e rápido com feedback ágil.</p>
      </div>
      <div class="column-64-copy w-col w-col-6 w-col-small-6"><img src="images/sistema-seguro-e-confiavel-da-justa-com-vc.jpg" alt="" class="image-61">
        <p class="paragraph-16">Sistema seguro e confiável. A Justa preza pela transparência!</p>
      </div>
    </div>
    <div class="columns-2 w-row">
      ...
      <div class="column-6-copy w-col w-col-5">
        <div class="columns-25 w-row">
          ...
          <div data-w-id="502e947a-3426-8493-ca8d-f085264b1079" class="column-4-copy5 w-col w-col-4"><img src="images/icone_4icone_2.png" alt="" class="image-3">
            <h1 class="_2">Sem asterisco</h1>
            <p class="_9">Não precisamos de sinais gráficos. JUSTO é ser transparente com você.</p>
          </div>
          <div class="column-5 w-col w-col-4"><img src="images/icone_6icone_3.png" alt="" class="image-3">
            <h1 class="_4">Segurança</h1>
            <p class="_10">Total controle e segurança com seu sistema e ferramentas.</p>
          </div>
        </div>
        <div class="w-row">
          <div class="w-col w-col-3 w-col-tiny-3"><img src="images/diversas-formas-para-escolher-como-pagar-seu-boleto-com-a-Justa.jpg" alt="" class="image-3"></div>
          <div class="w-col w-col-9 w-col-tiny-9">
            <p class="_8">Diversas formas para escolher como pagar o seu boleto ou do seu cliente, garantindo essa vantagem para seu estabelecimento.</p>
          </div>
        </div>
        <div class="w-row">
          <div class="w-col w-col-3 w-col-tiny-3"><img src="images/pagamento-em-ate-doze-vezes-no-cartao-de-credito-com-a-justa.jpg" alt="" class="image-3"></div>
          <div class="column-46 w-col w-col-9 w-col-tiny-9">
            <p class="_9">Pagamento em até 12 vezes no cartão de crédito, com taxas JUSTAS.</p>
          </div>
        </div>
        <div class="w-row">
          <div class="w-col w-col-3 w-col-tiny-3"><img src="images/atendimento-online-facil-e-rapido-com-feedback-na-justa-com-vc.jpg" alt="" class="image-3"></div>
          <div class="column-46 w-col w-col-9 w-col-tiny-9">
            <p class="_10">Atendimento online fácil e rápido com feedback ágil.</p>
          </div>
        </div>
        <div class="w-row">
          <div class="w-col w-col-3 w-col-tiny-3"><img src="images/sistema-seguro-e-confiavel-da-justa-com-vc.jpg" alt="" class="image-3"></div>
          <div class="column-46 w-col w-col-9 w-col-tiny-9">
            <p class="_11">Sistema seguro e confiável. A Justa preza pela transparência!</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="columns-39 w-row">
    <div class="column-62 w-col w-col-6"><img src="images/parcelinha-justa-boleto-pago.jpg" srcset="images/parcelinha-justa-boleto-pago-p-500.jpeg 500w, images/parcelinha-justa-boleto-pago-p-800.jpeg 800w, images/parcelinha-justa-boleto-pago.jpg 960w" sizes="(max-width: 767px) 100vw, 50vw" alt="" class="image-58"></div>
    <div class="w-col w-col-6"><img src="images/quero-minha-maquininha-que-paga-boleto.png" srcset="images/quero-minha-maquininha-que-paga-boleto-p-500.png 500w, images/quero-minha-maquininha-que-paga-boleto.png 592w" sizes="(max-width: 767px) 100vw, 48vw" alt="" class="image-59"></div>
  </div>
  <div class="section-25"><img src="images/quero-minha-maquininha-que-paga-boleto.png" srcset="images/quero-minha-maquininha-que-paga-boleto-p-500.png 500w, images/quero-minha-maquininha-que-paga-boleto.png 592w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 450px, 100vw" alt="" class="image-62"></div>
    ...
    <div class="columns-13 w-row">
      ...
      <div class="column-51 w-col w-col-6">
        ...
        <div class="columns-14 w-row">
          ...
          <div data-w-id="a3983a1b-f87b-d494-859e-dda5459ad6b9" class="column-33 w-col w-col-6"><a href="http://api.whatsapp.com/send?1=pt_BR&amp;phone=5501149496347" target="_blank" class="link-block-6 w-inline-block w-clearfix"><img src="images/icone_4_contato.png" alt="" class="image-22"><h1 class="contato_1">+55 11 94949-6347</h1></a></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
        <div class="col-12"><center><h3 style="color: rgb(0, 105, 145);">Parcelinha Justa</h3><h5 style="color: rgb(0, 105, 145);">Adquira a maquininha que paga boleto!</h5></center></div>
      ...
      <div class="row" style="text-align: center">  
        <center><div class="col-md-12 com-sm-12">
            <a class="button w-button"  id="btnEnviaInteresse" style="display: none; width: 100px;"  onClick="EnviaInteresse('parcelinha-justa.html', true, true)">Enviar</a>
